...
namespace Bearded_Dangerzone.GamePart
{
    class Player : Client
    {
        ...
        public Player()
        {
            textureSourceRectangle = TextureManager.GetSourceRectangle("player");
            AnimationState = 0;
        }
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (false)
            {
                spriteBatch.DrawString(TextureManager.GameFont, "Jumped: " + jumped.ToString(), new Vector2(Position.X, Position.Y - 50), Color.Black);
                spriteBatch.DrawString(TextureManager.GameFont, "JumpedUp: " + jumpedUp.ToString(), new Vector2(Position.X, Position.Y - 70), Color.Black);
                spriteBatch.DrawString(TextureManager.GameFont, "Bot: " + bot.ToString(), new Vector2(Position.X, Position.Y - 90), Color.Red);
                spriteBatch.DrawString(TextureManager.GameFont, "Left: " + left.ToString(), new Vector2(Position.X, Position.Y - 110), Color.Red);
                spriteBatch.DrawString(TextureManager.GameFont, "Right: " + right.ToString(), new Vector2(Position.X, Position.Y - 130), Color.Red);
        ...
        {
            sb.Draw(TextureManager.SpriteSheet, new Rectangle(r.X, r.Y, r.Width, 1), TextureManager.GetSourceRectangle("rectangleYellow"), Color.White);
            sb.Draw(TextureManager.SpriteSheet, new Rectangle(r.X, r.Y, 1, r.Height), TextureManager.GetSourceRectangle("rectangleYellow"), Color.White);
            sb.Draw(TextureManager.SpriteSheet, new Rectangle(r.Right, r.Y, 1, r.Height), TextureManager.GetSourceRectangle("rectangleYellow"), Color.White);
            sb.Draw(TextureManager.SpriteSheet, new Rectangle(r.X, r.Bottom, r.Width, 1), TextureManager.GetSourceRectangle("rectangleYellow"), Color.White);
        }
